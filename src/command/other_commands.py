...
def help_message():
    return (
        ...
        + "*️⃣For add new RSS url type: <b>/add *your_RSS_url*</b>\n<i>(optional)</i> if you want to give a name for that entry try: <b>/add *your_RSS_url* *name_of_entry*</b>\n\n"
        + "*️⃣For remove a feed type <b>/remove</b> and then click the target feed\n\n"
        + "*️⃣For change the default link type try <b>/list</b> then click the button below of your target link\n\n"
        + "*️⃣For get an instant article try to type <b>/get</b> then select your feed and then select how many articles do you want to receive!\n\n"
        + "*️⃣If you want to know more about this bot try <b>/about</b>"
    )
