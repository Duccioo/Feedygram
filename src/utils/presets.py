...
PRESETS_DATA: Dict[str, List[Dict[str, str]]] = {
    "💻 Tech & Dev": [
        ...
        {"name": "GitHub Trending Nuovi (Weekly)", "url": "https://duccioo.github.io/GitHubTrendingRSS/feeds/all_languages_weekly_new.xml"},
        {"name": "GitHub Trending Nuovi (Daily)", "url": "https://duccioo.github.io/GitHubTrendingRSS/feeds/all_languages_daily_new.xml"},
